...
class ConfigurationManager(object):
    ...
    def __init__(
        ...
        """create and initialize a configmanners object.

        parameters:
          definition_source - a namespace or list of namespaces from which
                              configmanners is to fetch the definitions of the
          ...
          use_auto_help - set to True if configmanners is to automatically set up
                          help output for command line invocations.
          use_admin_controls - configmanners can add command line flags that it
        ...
        try:
            ...
            # option in configmanners.  This error is ignorable
            pass
            ...
            for key in all_keys:
                ...
                try:
                    ...
                    if not isinstance(new_requirements, collections.abc.Mapping):
                        ...
                        # interpret 'new_req' as a configmanners requirement
