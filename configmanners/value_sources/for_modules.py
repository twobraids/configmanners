...
class ValueSource(object):
    ...
    def write(source_mapping, output_stream=sys.stdout):
        ...
        and values known to configmanners.
        """
        # a set of classes, modules and/or functions that are values in
        # configmanners options.  These values will have to be imported in the
        ...
        # in configmanners Options.  This set will be used to make a list of
        # these symbols, to forewarn a future configmanners that reads this
        # module, that it can ignore these symbols. This will prevent that
        # future configmanners from issuing a "mismatced symbols" warinng.
        ...
        print("# generated Python configmanners file\n", file=output_stream)
