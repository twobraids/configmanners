...
class SubparserFromStringConverter(object):
    ...
    with subparsers, and a from string converer. It is used in configmanners as the
    from_string_converter for the Option that corresponds with the subparser
    argparse action.  Once configmanners as assigned the final value to the
    ...
    def add_namespace(self, name, a_namespace):
        ...
        translated into configmanners options.  Each of those options must be
    ...
    def __call__(self, subparser_name):
        ...
        class SubparserValue(str):
            ...
            the final value of the subparser configmanners option.  It is a string,
...
# ==============================================================================
class configmannersSubParsersAction(argparse._SubParsersAction):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(configmannersSubParsersAction, self).__init__(*args, **kwargs)
    ...
    def add_parser(self, *args, **kwargs):
        ...
        configmanners, we'll need to reproduce the subparsers exactly without
        resorting to copying.  We save the args & kwargs in the 'foreign_data'
        section of the configmanners option that corresponds with the subparser
        action."""
        command_name = args[0]
    ...
    # --------------------------------------------------------------------------
    def add_configmanners_option(self, an_option):
        self._configmanners_option = an_option
...
class ArgumentParser(argparse.ArgumentParser):
    ...
    parsing methods and hands off to configmanners.  configmanners then calls back
    ...
    argparse Namespace object, but a configmanners DotDict.  This means that it
    ...
    # --------------------------------------------------------------------------
    def get_required_config(self):
        """because of the exsistance of subparsers, the configmanners options
    ...
    def add_argument(self, *args, **kwargs):
        ...
        argument system in both the argparse and configmanners worlds.  Each call
        to this method returns a standard argparse Action object as well as
        adding an equivalent configmanners Option object to the required_config
        ...
        corresponding configmanners Option."""
        ...
        if argparse_action_name == 'store':
            if argparse_dest is None:
                ...
                if not configmanners_name:
                    configmanners_name = args[0]
            else:
                configmanners_name = argparse_dest
                configmanners_is_argument = not argparse_option_strings
            configmanners_default = argparse_default
        ...
        # STORE_TRUE /  STORE_FALSE
            ...
            if argparse_dest is None:
                ...
                configmanners_name = argparse_dest
            configmanners_default = argparse_default
            configmanners_from_string = boolean_converter
            configmanners_to_string = to_str
        ...
        # configmanners uses the switch name as the name of the key inwhich to
        # store values.  argparse is able to use different names for each.
        # this means that configmanners may encounter repeated targets.  Rather
        # than overwriting Options with new ones with the same name, configmanners
        ...
        self.required_config.add_option(
            name=configmanners_name,
            default=configmanners_default,
            doc=configmanners_doc,
            from_string_converter=configmanners_from_string,
            to_string_converter=configmanners_to_string,
            # short_form=configmanners_short_form,
            is_argument=configmanners_is_argument,
            not_for_definition=configmanners_not_for_definition,
    ...
    def add_subparsers(self, *args, **kwargs):
        ...
        configmanners_not_for_definition = True
        ...
        subparser_action.add_configmanners_option(self.configmanners_subparsers_option)
    ...
    def set_defaults(self, **kwargs):
        ...
        configmanners has no equivalent.  These will be added back to the configmanners
    ...
    def parse_args(self, args=None, namespace=None):
        ...
        shimming configmanners into the process. The return value will be a
        configmanners DotDict rather than an argparse Namespace."""
        ...
        # embedded '-' characters in them.  configmanners requires that option
        # follow the Python Identifier rules.  Fortunately, configmanners has a
        # class that will perform dynamic translation of keys.  In this
        # code fragment, we fetch the final configuration from configmanners
        ...
        # of argparse.
        if self.configmanners_subparsers_option:
...
def setup_definitions(source, destination):
    """this method stars the process of configmanners reading and using an argparse
