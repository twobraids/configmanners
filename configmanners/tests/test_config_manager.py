...
from configmanners.converters import class_converter, to_str
from configmanners.datetime_util import datetime_from_ISO_string
from configmanners.config_exceptions import NotAnOptionError
...
"""
    ...
    def test_help_out(self):
        ...
        class Myconfigmannersager(config_manager.ConfigurationManager):
            def output_summary(inner_self):
                ...
                r = super(Myconfigmannersager, inner_self).output_summary(
    ...
    def test_log_config(self):
        ...
        e = [
            ...
            "application: <class 'configmanners.tests.test_config_manager.MyApp'>",
    ...
    def test_print_conf(self):
        ...
        class Myconfigmannersager(config_manager.ConfigurationManager):
            ...
            def print_conf(self):
                ...
                sys.stdout = 17
                try:
                    super(Myconfigmannersager, self).print_conf()
                finally:
    ...
    def test_value_source_object_hook_2(self):
        ...
        as they're used in configmanners.  Define a mapping that insures that all
