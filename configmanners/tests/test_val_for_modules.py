...
from configmanners import RequiredConfig, Namespace, ConfigurationManager, command_line
from configmanners.option import Option
from configmanners.config_exceptions import CannotConvertError, NotAnOptionError
from configmanners.value_sources.for_modules import (
    OrderableObj,
    OrderableTuple,
    ValueSource,
)
...
class Delta(RequiredConfig):
    required_config = Namespace()
    required_config.add_option("messy", doc="messy", default=-99)
    required_config.add_option(
        "dd", doc="dd", default=Beta, from_string_converter=class_converter
    )
...
class TestCase(unittest.TestCase):
    ...
    def test_basic_import(self):
        config_manager = Mock()
        vs = ValueSource("configmanners.tests.values_for_module_tests_1")
    ...
    def test_failure_1(self):
        ...
        self.assertRaises(
            CannotConvertError,
            ValueSource,
            "configmanners.tests.values_4_module_tests_1",
        )
    ...
    def test_failure_2(self):
        ...
        self.assertRaises(
            CannotConvertError,
            ValueSource,
            "configmanners/tests/test_val_for_modules.py",
        )
    ...
    def test_as_overlay(self):
        ...
        cm = ConfigurationManager(
            [rc],
            values_source_list=[
                "configmanners.tests.values_for_module_tests_2",
                "configmanners.tests.values_for_module_tests_3",
            ],
        )
        ...
        from configmanners.tests.values_for_module_tests_3 import Alpha
    ...
    def test_as_overlay_bad_symbols_with_strict(self):
        ...
        self.assertRaises(
            ...
            values_source_list=[
                "configmanners.tests.values_for_module_tests_2",
                "configmanners.tests.values_for_module_tests_4",
                command_line,
            ],
    ...
    def test_write_with_imported_module(self):
        import os
        from configmanners.tests.values_for_module_tests_1 import Alpha, foo, a
        ...
        expected = """# generated Python configmanners file

from configmanners.dotdict import DotDict
from configmanners.tests.values_for_module_tests_1 import (
    Alpha,
    foo,
)
...
# the following symbols will be ignored by configmanners when
...
"""
    ...
    def test_write_with_imported_module_with_internal_mappings(self):
        import os
        from configmanners.tests.values_for_module_tests_1 import Alpha, foo
...
"""
    ...
    def test_orderable_obj(self):
        d = {"a": 1, 3: 4, None: 3}
        sorted_list = [y.value for y in sorted([OrderableObj(x) for x in d.keys()])]
