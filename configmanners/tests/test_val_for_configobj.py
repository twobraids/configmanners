...
foo=bar  # other comment
        """
            ...
            try:
                ...
                r = {"othersection": {"foo": "bar"}, "name": "Peter", "awesome": ""}
        ...
        """
            ...
            try:
                ...
                self.assertEqual(
                    ...
                    {"othersection": {"foo": "bar"}, "name": "Peter", "awesome": ""},
                )
                self.assertEqual(
                    o.get_values(c, True),
                    {"othersection": {"foo": "bar"}, "name": "Peter", "awesome": ""},
...
"""
        ...
        def test_write_ini_with_reference_value_froms(self):
            ...
            external_values = {
                "xxx": {"yyy": {"password": "dwight and wilma"}},
            }
            c = ConfigurationManager(
                [n],
        ...
        def test_configobj_relative_includes(self):
            ...
            try:
                ...
                with tempfile.NamedTemporaryFile(
                    "w", suffix="ini", dir=db_creds_dir, delete=False
                ) as f:
                    include_file_name = f.name
                ...
                with tempfile.NamedTemporaryFile(
                    "w", suffix="ini", dir=ini_repo_dir, delete=False
                ) as f:
                    ini_file_name = f.name
                    contents = (
                        "+include ../%s/%s\n"
