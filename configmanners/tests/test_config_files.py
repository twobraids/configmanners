...
from configmanners import command_line
...
class TestCase(unittest.TestCase):
    def _some_namespaces(self):
        ...
        n.c.add_option("dwight", "stupid, deadly", "husband from Flintstones")
    ...
    # ----------------------------------------------------------------------
    def test_configdir_exists_and_default_config_exists_and_config_required(self):
        temp_config_dir = "/tmp"
        with open("/tmp/dwight.ini", "w") as f:
            f.write("[x]\n    size=42")
        try:
    ...
    # ----------------------------------------------------------------------
    def test_overridden_configfile_doesnt_exist(self):
        temp_config_dir = "/tmp"
        with open("/tmp/dwight.ini", "w") as f:
            f.write("")
        try:
    ...
    def test_default_config_exists_config_required_overridden_correctly(self):
        temp_config_dir = "/tmp"
        with open("/tmp/dwight.ini", "w") as f:
            f.write("[x]\n    size=42")
        try:
    ...
    def test_configdir_default_config_config_required_overridden_correctly_2(self):
        temp_config_dir = "/tmp"
        with open("/tmp/dwight.ini", "w") as f:
            f.write("")
        try:
    ...
    def test_configdir_default_config_config_required_overridden_incorrectly_2(self):
        temp_config_dir = "/tmp"
        with open("/tmp/dwight.ini", "w") as f:
            f.write("")
        try:
