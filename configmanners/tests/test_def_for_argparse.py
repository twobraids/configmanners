...
from configmanners import ArgumentParser
from configmanners.dotdict import DotDict

expected_value = {
    "test_expansion_subparsers_1": """usage: highwater [-h] [--admin.print_conf ADMIN.PRINT_CONF]
...
optional arguments:
  ...
  --egg EGG             eggs
""",
    "test_expansion_subparsers_2": """usage: highwater a [-h] [--admin.print_conf ADMIN.PRINT_CONF]
                   [--admin.dump_conf ADMIN.DUMP_CONF] [--admin.strict]
...
optional arguments:
  ...
  --fff FFF             a fff help
""",
    "test_expansion_subparsers_3": """usage: highwater b [-h] [--admin.print_conf ADMIN.PRINT_CONF]
                   [--admin.dump_conf ADMIN.DUMP_CONF] [--admin.strict]
                   [--admin.expose_secrets] [--admin.conf ADMIN.CONF]
                   [--baz {X,Y,Z}] [--fff {X,Y,Z}]
...
""",
    "test_expansion_subparsers_4": """usage: highwater [--admin.print_conf ADMIN.PRINT_CONF]
                 [--admin.dump_conf ADMIN.DUMP_CONF] [--admin.strict]
...
""",
    "test_expansion_subparsers_5": """usage: highwater a [-h] [--admin.print_conf ADMIN.PRINT_CONF]
                   [--admin.dump_conf ADMIN.DUMP_CONF] [--admin.strict]
...
""",
    "test_expansion_subparsers_6": """usage: highwater [-h] [--admin.print_conf ADMIN.PRINT_CONF]
                 [--admin.dump_conf ADMIN.DUMP_CONF] [--admin.strict]
                 [--admin.expose_secrets] [--admin.why] [--admin.conf ADMIN.CONF] [--foo]
                 [--egg EGG]
                 {a,b} ...
...
""",
    "test_expansion_subparsers_7": """usage: highwater [-h] [--admin.print_conf ADMIN.PRINT_CONF]
                 [--admin.dump_conf ADMIN.DUMP_CONF] [--admin.strict]
                 [--admin.expose_secrets] [--admin.why] [--admin.conf ADMIN.CONF] [--foo]
                 [--egg EGG]
                 {a,b} ...
...
""",
    "test_expansion_subparsers_defaults_values_1": DotDict(
        {
            "foo": None,
            "egg": None,
            "sub_command": "a",
    ...
    "test_expansion_subparsers_defaults_values_2": DotDict(
        {
            "foo": None,
            "egg": None,
            "sub_command": "a",
    ...
    "test_expansion_subparsers_defaults_values_3": DotDict(
        {
            "foo": None,
            "egg": None,
            "sub_command": "b",
...
class TestCaseForDefSourceArgparse(TestCase):
    ...
    def test_parser_9(self):
        ...
        self.assertEqual(config.collection, [])
        self.assertEqual(
            config.const_collection, ["value-1-to-append", "value-2-to-append"]
        )
    ...
    def test_expansion_subparsers_stderr_with_exit(self):
        tests = (
            ...
            (
                ["a", "16", "--fff", "21", "--baz", "Y"],
                expected_value["test_expansion_subparsers_6"],
            ),
    ...
    def test_expansion_subparsers_values(self):
        tests = (
            (
                ["a", "16"],
                expected_value["test_expansion_subparsers_defaults_values_1"],
            ),
            (
                ["a", "16", "--fff=9"],
                expected_value["test_expansion_subparsers_defaults_values_2"],
            ),
            (
                ["a", "16", "--fff", "9"],
                expected_value["test_expansion_subparsers_defaults_values_2"],
            ...
            (
                ["b", "--fff", "X"],
                expected_value["test_expansion_subparsers_defaults_values_3"],
            ),
        )
        parser = self.setup_subparser()
        for args, expected in tests:
